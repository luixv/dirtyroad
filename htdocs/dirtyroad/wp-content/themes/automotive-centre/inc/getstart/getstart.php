    ...
    <div class="tab-sec">
		<div class="tab">
			<button class="tablinks" onclick="automotive_centre_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'automotive-centre' ); ?></button>
		  	<button class="tablinks" onclick="automotive_centre_open_tab(event, 'automotive_lite')"><?php esc_html_e( 'Setup With Customizer', 'automotive-centre' ); ?></button>		  
			...
			<div class="block-pattern-img">
				...
				<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','automotive-centre'); ?></p>
	          	...
	          	<div class="automotive-centre-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=page' ) ); ?>" target="_blank" class="vw-pattern-page-btn button-primary button"><?php esc_html_e('Add New Page','automotive-centre'); ?></a>
			    </div>
		...
		<div id="automotive_lite" class="tabcontent">

...
class ERForms_Form_Cards extends ERForms_List_Cards {
	...
	public function prepare_items() {
		...
		$out = '<div class="erf-card-content">';
                ...
                $total= erforms()->submission->get_sub_count_by_form($form['id']);  
                $out .= '<div class="erf-submission-count"><a href="'.admin_url("/admin.php?page=erforms-submissions&erform_id=".$form['id']).'"> '.$total.' <span class="erf-detail-title"><small>'.__('Submissions','erforms').'</small></span></a></div>';
                $out .= '</div>';
                return $out;

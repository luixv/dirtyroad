...
class ERForms_Do_Actions {
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_nopriv_erf_submission_nonce', array($this, 'submission_nonce'));
        add_action('wp_ajax_erf_submission_nonce', array($this, 'submission_nonce'));
    }
...
//            }
    ...
    public function submission_nonce(){
         wp_send_json_success(array('token' => wp_create_nonce('erform_submission_nonce')));
    }
}

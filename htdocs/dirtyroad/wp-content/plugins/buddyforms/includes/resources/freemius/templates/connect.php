...
<div id="fs_theme_connect_wrapper">
 ...
 if ( $show_close_button ) { ?>
	...
	<div id="fs_connect"
		...
		<div class="fs-visual">
			...
			<?php
 $vars = array( 'id' => $fs->get_id() ); fs_require_once_template( 'plugin-icon.php', $vars ); ?>
 ...
 foreach ( $permissions as $id => $permission ) : ?>
	...
	<?php
 $fs->do_action( 'connect/after' ); if ( $is_optin_dialog ) { ?>
</div>
<?php
 } ?>

                ...
                if ( ! isset( $last_notified[ $user_id ][ $thread_id ] ) || ( $thread->last_id > $last_notified[ $user_id ][ $thread_id ] ) ) {
                    ...
                    if( $email_overwritten === false ) {
                        ...
                        if (function_exists('bp_send_email')) {
                            $args = array(
                                'tokens' =>
                                    apply_filters('bp_better_messages_notification_tokens', array(
                                        ...
                                        'subject' => ltrim(sanitize_text_field(stripslashes($messages[0]->subject)), 'Re: '),
                            ...
                            $subject = sprintf(_x('You have unread messages: "%s"', 'Email notification header for non BuddyPress websites', 'bp-better-messages'), ltrim(sanitize_text_field(stripslashes($messages[0]->subject)), 'Re: '));

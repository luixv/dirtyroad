    ...
    class BP_Better_Messages_Hooks
    {
        ...
        public function __construct()
        {
            ...
            */
            ...
            if( BP_Better_Messages()->settings['template'] !== 'standard' ){
                add_filter( 'body_class', array( $this, 'add_body_class_for_template' ), 10, 3);
            }
        }

        public function add_body_class_for_template($classes){
        ...
        public function css_customizations(){
            ...
            if( ! empty( BP_Better_Messages()->settings['colorGeneral'] ) && BP_Better_Messages()->settings['colorGeneral'] !== '#21759b' ){
                ...
                $rules[] = '.bpbmuc{background: ' . $main_color . '}';
                $rules[] = '.bp-messages-wrap .list .messages-stack .content .messages-list li .status{color: ' . $main_color . '}';
                $rules[] = 'a.bpbm-pm-button,a.bpbm-pm-button:hover,a.bpbm-pm-button:focus{background-color: ' . $main_color . '}';
                ...
                if( BP_Better_Messages()->settings['template'] === 'modern' ) {
                    $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack.incoming .content .messages-list li .message-content{border-color:' . $main_color . ';background:' . $main_color . '}';
                    $border_radius = BP_Better_Messages()->settings['modernBorderRadius'];
                    if( $border_radius != 2 ){
                        $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack .content .messages-list li .message-content{border-radius:' . $border_radius . 'px}';
                        $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack .content .messages-list li .bpbm-attachments .videos .video video{border-radius:' . $border_radius . 'px}';
                        $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack .content .messages-list li .bpbm-attachments .images a{border-radius:' . $border_radius . 'px}';
                        $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack .content .messages-list li .bpbm-gif{border-radius:' . $border_radius . 'px}';
                        $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack .content .messages-list li .bp-messages-iframe-container{border-radius:' . $border_radius . 'px}';
                        $rules[] = 'body.bpbm-template-modern .bp-messages-wrap .list .messages-stack.incoming .content .messages-list li.selected .message-content:before{border-radius:' . $border_radius . 'px}';

...
?><div class="bp-messages-wrap <?php if( $is_in_groups_now ) { echo 'bp-messages-group-thread'; } else { echo 'bp-messages-wrap-main'; }; ?>" data-thread-id="<?php esc_attr_e($thread_id); ?>">

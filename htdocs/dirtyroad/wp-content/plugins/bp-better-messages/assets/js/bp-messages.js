...
(function ($) {
    ...
    function BPBMUpdateUnreadCount( unread ){
        ...
        BP_Messages.total_unread = unread;
    ...
    $(document).ready(function () {
        ...
        bpMessagesWrap.on('click', '.messages-list li .bpbm-reply', function (event) {
            ...
            if (descs.length > 0 ) {
                descs.each(function(){
                    ...
                    if (typeof _desc !== 'undefined') {
                        content += '<span class="bpbm-preview-desc">' + atob(_desc) + '</span>';
                    }
                });
            }
            ...
            '<span class="bpbm-preview-message-name">' + name + '</span>' +
            '<div class="bpbm-preview-message-text">' + content + '</div>' +
            '</div>' +
            '</div>';
            ...
            if( previewMessage.length > 0 ){
                previewMessage.replaceWith(html);
                wrap.find('.bpbm-preview-message').show();

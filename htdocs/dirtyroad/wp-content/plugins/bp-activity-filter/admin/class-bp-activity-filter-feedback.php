...
@media (max-width: 767px) {
	...
	.notice.bp-activity-filter-notice .bp-activity-filter-notice-inner .no-thanks {
		...
		public function set_no_bug() {
			...
			if ( ! isset( $_GET['_wpnonce'] ) || ( ! wp_verify_nonce( $_GET['_wpnonce'], 'bp-activity-filter-feedback-nounce' ) || ! is_admin() || ! isset( $_GET[ $this->nobug_option ] ) || ! current_user_can( 'manage_options' ) ) ) {
				return;
			}

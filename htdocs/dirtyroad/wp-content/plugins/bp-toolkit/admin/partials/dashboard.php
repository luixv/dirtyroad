...
if ( class_exists( 'BuddyPress' ) ) {
    ...
    ?>"><i
                                        class="fa fa-ban fa-fw"></i><span><?php 
    ...
    ?>"><i
                                        class="fa fa-lock fa-fw"></i><span><?php 
    ...
    ?>"><i
                                        class="fa fa-flag fa-fw"></i><span><?php 
    ...
    ?>"><i
                                        class="fa fa-folder fa-fw"></i><span><?php 
    ...
    ?>
                            ...
                            <li><a class="isDisabled"><i
                                            class="fa fa-check fa-fw"></i><span><?php 
...
?></p>
                <p><a href="https://wordpress.org/plugins/bp-toolkit/#reviews" target="_blank"><i
                                class="dashicons dashicons-wordpress"></i> <?php 
...
?></a></p>
                <p><a href="https://www.bouncingsprout.com/support#contact" target="_blank"><i
                                class="dashicons dashicons-format-status"></i> <?php 

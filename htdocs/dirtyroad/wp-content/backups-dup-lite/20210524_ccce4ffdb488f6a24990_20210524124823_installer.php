...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210524_ccce4ffdb488f6a24990_20210524124823_archive.zip';
	const ARCHIVE_SIZE		 = '79002594';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ccce4ff-24124823';
    const SECONDARY_PACKAGE_HASH = 'c91626e-24124823';
	const VERSION			 = '1.4.0';

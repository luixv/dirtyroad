...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210524_accbf4e072824f1b7838_20210524214100_archive.zip';
	const ARCHIVE_SIZE		 = '76067298';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'accbf4e-24214100';
    const SECONDARY_PACKAGE_HASH = 'f8d838c-24214100';
	const VERSION			 = '1.4.0';

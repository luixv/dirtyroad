...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210524_a90f35cfa97c4f658550_20210530193632_archive.zip';
	const ARCHIVE_SIZE		 = '479713';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a90f35c-30193632';
    const SECONDARY_PACKAGE_HASH = '4681175-30193632';
	const VERSION			 = '1.4.1';

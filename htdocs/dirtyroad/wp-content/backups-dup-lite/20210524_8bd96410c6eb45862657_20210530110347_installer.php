...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210524_8bd96410c6eb45862657_20210530110347_archive.zip';
	const ARCHIVE_SIZE		 = '78351761';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8bd9641-30110347';
    const SECONDARY_PACKAGE_HASH = 'ca896e5-30110347';
	const VERSION			 = '1.4.1';

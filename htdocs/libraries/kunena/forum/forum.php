...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date  = ('2021-01-13' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2021-01-13';
		self::$version_name  = ('Iris' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Iris';
	}
